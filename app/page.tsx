  ...
  const featuredContainers = [
    {
      ...
      rating: 4.9,
      players: "87,432 members", // Changed from "active sessions"
      bidOwner: "TrialDealer64",
      bidAmount: "$156.78",
    ...
    },
    {
      ...
      rating: 4.5,
      players: "42,876 members",
      bidOwner: "CreativePro",
      bidAmount: "$445.99",
    ...
    },
    {
      ...
      rating: 4.3,
      players: "156,789 members",
      bidOwner: "MusicLover88",
      bidAmount: "$89.25",
      ownership: "Community Owned",
    },
  ]
